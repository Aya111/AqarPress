...
namespace AqarPress.Data.DatabaseSpecific
{
	...
	internal class PersistenceInfoProviderCore : PersistenceInfoProviderBase
	{
		...
		{
			this.AddElementMapping("AreaEntity", @"AqarPress", @"dbo", "Area", 3, 0);
		...
		{
			this.AddElementMapping("CategoryEntity", @"AqarPress", @"dbo", "Category", 3, 0);
		...
		{
			this.AddElementMapping("DeveloperEntity", @"AqarPress", @"dbo", "Developer", 5, 0);
		...
		{
			this.AddElementMapping("ProjectEntity", @"AqarPress", @"dbo", "Project", 8, 0);
		...
		{
			this.AddElementMapping("ProjectDiscussionEntity", @"AqarPress", @"dbo", "ProjectDiscussion", 5, 0);
		...
		{
			this.AddElementMapping("ProjectSubCategoryTableEntity", @"AqarPress", @"dbo", "ProjectSubCategoryTable", 3, 0);
		...
		{
			this.AddElementMapping("RoleEntity", @"AqarPress", @"dbo", "Role", 2, 0);
		...
		{
			this.AddElementMapping("SubCategoryEntity", @"AqarPress", @"dbo", "SubCategory", 3, 0);
		...
		{
			this.AddElementMapping("UserEntity", @"AqarPress", @"dbo", "User", 8, 0);
