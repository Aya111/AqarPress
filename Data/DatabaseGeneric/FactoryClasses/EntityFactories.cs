...
namespace AqarPress.Data.FactoryClasses
{
	...
	{
		private readonly AqarPress.Data.EntityType _typeOfEntity;
		...
		public EntityFactoryBase2(string entityName, AqarPress.Data.EntityType typeOfEntity, bool isInHierarchy) : base(entityName)
		{
		...
		/// <inheritdoc/>
		public override IEntity2 CreateEntityFromEntityTypeValue(int entityTypeValue) {	return GeneralEntityFactory.Create((AqarPress.Data.EntityType)entityTypeValue); }
	...
	{
		/// <summary>CTor</summary>
		public AreaEntityFactory() : base("AreaEntity", AqarPress.Data.EntityType.AreaEntity, false) { }
		/// <inheritdoc/>
	...
	{
		/// <summary>CTor</summary>
		public CategoryEntityFactory() : base("CategoryEntity", AqarPress.Data.EntityType.CategoryEntity, false) { }
		/// <inheritdoc/>
	...
	{
		/// <summary>CTor</summary>
		public DeveloperEntityFactory() : base("DeveloperEntity", AqarPress.Data.EntityType.DeveloperEntity, false) { }
		/// <inheritdoc/>
	...
	{
		/// <summary>CTor</summary>
		public ProjectEntityFactory() : base("ProjectEntity", AqarPress.Data.EntityType.ProjectEntity, false) { }
		/// <inheritdoc/>
	...
	{
		/// <summary>CTor</summary>
		public ProjectDiscussionEntityFactory() : base("ProjectDiscussionEntity", AqarPress.Data.EntityType.ProjectDiscussionEntity, false) { }
		/// <inheritdoc/>
	...
	{
		/// <summary>CTor</summary>
		public ProjectSubCategoryTableEntityFactory() : base("ProjectSubCategoryTableEntity", AqarPress.Data.EntityType.ProjectSubCategoryTableEntity, false) { }
		/// <inheritdoc/>
	...
	{
		/// <summary>CTor</summary>
		public RoleEntityFactory() : base("RoleEntity", AqarPress.Data.EntityType.RoleEntity, false) { }
		/// <inheritdoc/>
	...
	{
		/// <summary>CTor</summary>
		public SubCategoryEntityFactory() : base("SubCategoryEntity", AqarPress.Data.EntityType.SubCategoryEntity, false) { }
		/// <inheritdoc/>
	...
	{
		/// <summary>CTor</summary>
		public UserEntityFactory() : base("UserEntity", AqarPress.Data.EntityType.UserEntity, false) { }
		/// <inheritdoc/>
	...
	public partial class GeneralEntityFactory
	{
		...
		public static IEntity2 Create(AqarPress.Data.EntityType entityTypeToCreate)
		{
	...
	public static class EntityFactoryFactory
	{
		...
		{
			foreach(int entityTypeValue in Enum.GetValues(typeof(AqarPress.Data.EntityType)))
			{
				var factory = GetFactory((AqarPress.Data.EntityType)entityTypeValue);
		...
		/// <summary>Gets the factory of the entity with the AqarPress.Data.EntityType specified</summary>
		/// <param name="typeOfEntity">The type of entity.</param>
		/// <returns>factory to use or null if not found</returns>
		public static IEntityFactory2 GetFactory(AqarPress.Data.EntityType typeOfEntity)
		{
			switch(typeOfEntity)
			{
				case AqarPress.Data.EntityType.AreaEntity:
					return new AreaEntityFactory();
				case AqarPress.Data.EntityType.CategoryEntity:
					return new CategoryEntityFactory();
				case AqarPress.Data.EntityType.DeveloperEntity:
					return new DeveloperEntityFactory();
				case AqarPress.Data.EntityType.ProjectEntity:
					return new ProjectEntityFactory();
				case AqarPress.Data.EntityType.ProjectDiscussionEntity:
					return new ProjectDiscussionEntityFactory();
				case AqarPress.Data.EntityType.ProjectSubCategoryTableEntity:
					return new ProjectSubCategoryTableEntityFactory();
				case AqarPress.Data.EntityType.RoleEntity:
					return new RoleEntityFactory();
				case AqarPress.Data.EntityType.SubCategoryEntity:
					return new SubCategoryEntityFactory();
				case AqarPress.Data.EntityType.UserEntity:
	...
	{
		/// <summary>Gets the factory of the Entity type with the AqarPress.Data.EntityType value passed in</summary>
		...
		{
			return new DynamicRelation(leftOperand, joinType, (AqarPress.Data.EntityType)Enum.Parse(typeof(AqarPress.Data.EntityType), rightOperandEntityName, false), aliasRightOperand, onClause);
		}

		/// <inheritdoc/>
		public override IDynamicRelation CreateDynamicRelation(string leftOperandEntityName, JoinHint joinType, string rightOperandEntityName, string aliasLeftOperand, string aliasRightOperand, IPredicate onClause)
		{
			return new DynamicRelation((AqarPress.Data.EntityType)Enum.Parse(typeof(AqarPress.Data.EntityType), leftOperandEntityName, false), joinType, (AqarPress.Data.EntityType)Enum.Parse(typeof(AqarPress.Data.EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
		}
		
		/// <inheritdoc/>
		public override IDynamicRelation CreateDynamicRelation(IEntityFieldCore leftOperand, JoinHint joinType, string rightOperandEntityName, string aliasLeftOperand, string aliasRightOperand, IPredicate onClause)
		{
			return new DynamicRelation(leftOperand, joinType, (AqarPress.Data.EntityType)Enum.Parse(typeof(AqarPress.Data.EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
		}
		
		/// <inheritdoc/>
		protected override IEntityFactoryCore GetFactoryImpl(int entityTypeValue) { return EntityFactoryFactory.GetFactory((AqarPress.Data.EntityType)entityTypeValue); }
