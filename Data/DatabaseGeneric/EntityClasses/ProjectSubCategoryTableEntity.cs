...
namespace AqarPress.Data.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class ProjectSubCategoryTableEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("ProjectSubCategoryTableEntity", InheritanceHierarchyType.None, false, (int)AqarPress.Data.EntityType.ProjectSubCategoryTableEntity, typeof(ProjectSubCategoryTableEntity), typeof(ProjectSubCategoryTableEntityFactory), false);
				AddNavigatorMetaData<ProjectSubCategoryTableEntity, ProjectEntity>("Project", "ProjectSubCategoryTables", (a, b) => a._project = b, a => a._project, (a, b) => a.Project = b, AqarPress.Data.RelationClasses.StaticProjectSubCategoryTableRelations.ProjectEntityUsingProjectIdStatic, ()=>new ProjectSubCategoryTableRelations().ProjectEntityUsingProjectId, null, new int[] { (int)ProjectSubCategoryTableFieldIndex.ProjectId }, null, true, (int)AqarPress.Data.EntityType.ProjectEntity);
				AddNavigatorMetaData<ProjectSubCategoryTableEntity, SubCategoryEntity>("SubCategory", "ProjectSubCategoryTables", (a, b) => a._subCategory = b, a => a._subCategory, (a, b) => a.SubCategory = b, AqarPress.Data.RelationClasses.StaticProjectSubCategoryTableRelations.SubCategoryEntityUsingSubCategoryIdStatic, ()=>new ProjectSubCategoryTableRelations().SubCategoryEntityUsingSubCategoryId, null, new int[] { (int)ProjectSubCategoryTableFieldIndex.SubCategoryId }, null, true, (int)AqarPress.Data.EntityType.SubCategoryEntity);
			}
		}
