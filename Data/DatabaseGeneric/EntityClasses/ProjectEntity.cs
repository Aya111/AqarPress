...
namespace AqarPress.Data.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class ProjectEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("ProjectEntity", InheritanceHierarchyType.None, false, (int)AqarPress.Data.EntityType.ProjectEntity, typeof(ProjectEntity), typeof(ProjectEntityFactory), false);
				AddNavigatorMetaData<ProjectEntity, EntityCollection<ProjectDiscussionEntity>>("ProjectDiscussions", a => a._projectDiscussions, (a, b) => a._projectDiscussions = b, a => a.ProjectDiscussions, () => new ProjectRelations().ProjectDiscussionEntityUsingProjectId, typeof(ProjectDiscussionEntity), (int)AqarPress.Data.EntityType.ProjectDiscussionEntity);
				AddNavigatorMetaData<ProjectEntity, EntityCollection<ProjectSubCategoryTableEntity>>("ProjectSubCategoryTables", a => a._projectSubCategoryTables, (a, b) => a._projectSubCategoryTables = b, a => a.ProjectSubCategoryTables, () => new ProjectRelations().ProjectSubCategoryTableEntityUsingProjectId, typeof(ProjectSubCategoryTableEntity), (int)AqarPress.Data.EntityType.ProjectSubCategoryTableEntity);
				AddNavigatorMetaData<ProjectEntity, CategoryEntity>("Category", "Projects", (a, b) => a._category = b, a => a._category, (a, b) => a.Category = b, AqarPress.Data.RelationClasses.StaticProjectRelations.CategoryEntityUsingCategoryIdStatic, ()=>new ProjectRelations().CategoryEntityUsingCategoryId, null, new int[] { (int)ProjectFieldIndex.CategoryId }, null, true, (int)AqarPress.Data.EntityType.CategoryEntity);
				AddNavigatorMetaData<ProjectEntity, DeveloperEntity>("Developer", "Projects", (a, b) => a._developer = b, a => a._developer, (a, b) => a.Developer = b, AqarPress.Data.RelationClasses.StaticProjectRelations.DeveloperEntityUsingDeveloperIdStatic, ()=>new ProjectRelations().DeveloperEntityUsingDeveloperId, null, new int[] { (int)ProjectFieldIndex.DeveloperId }, null, true, (int)AqarPress.Data.EntityType.DeveloperEntity);
			}
		}
