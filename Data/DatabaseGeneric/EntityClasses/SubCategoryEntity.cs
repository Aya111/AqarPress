...
namespace AqarPress.Data.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class SubCategoryEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("SubCategoryEntity", InheritanceHierarchyType.None, false, (int)AqarPress.Data.EntityType.SubCategoryEntity, typeof(SubCategoryEntity), typeof(SubCategoryEntityFactory), false);
				AddNavigatorMetaData<SubCategoryEntity, EntityCollection<ProjectSubCategoryTableEntity>>("ProjectSubCategoryTables", a => a._projectSubCategoryTables, (a, b) => a._projectSubCategoryTables = b, a => a.ProjectSubCategoryTables, () => new SubCategoryRelations().ProjectSubCategoryTableEntityUsingSubCategoryId, typeof(ProjectSubCategoryTableEntity), (int)AqarPress.Data.EntityType.ProjectSubCategoryTableEntity);
			}
		}
