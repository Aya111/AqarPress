...
namespace DB_A4D6F8_AqarPress.Data.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class AreaEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("AreaEntity", InheritanceHierarchyType.None, false, (int)DB_A4D6F8_AqarPress.Data.EntityType.AreaEntity, typeof(AreaEntity), typeof(AreaEntityFactory), false);
			}
		}
