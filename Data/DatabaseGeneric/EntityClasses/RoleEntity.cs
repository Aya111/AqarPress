...
namespace DB_A4D6F8_AqarPress.Data.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class RoleEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("RoleEntity", InheritanceHierarchyType.None, false, (int)DB_A4D6F8_AqarPress.Data.EntityType.RoleEntity, typeof(RoleEntity), typeof(RoleEntityFactory), false);
				AddNavigatorMetaData<RoleEntity, EntityCollection<UserEntity>>("Users", a => a._users, (a, b) => a._users = b, a => a.Users, () => new RoleRelations().UserEntityUsingRoleId, typeof(UserEntity), (int)DB_A4D6F8_AqarPress.Data.EntityType.UserEntity);
			}
		}
		...
		/// <remarks>Mapped on  table field: "Role"."id".<br/>Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0.<br/>Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		...
		/// <remarks>Mapped on  table field: "Role"."name".<br/>Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 500.<br/>Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
