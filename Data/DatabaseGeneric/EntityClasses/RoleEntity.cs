...
namespace AqarPress.Data.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class RoleEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("RoleEntity", InheritanceHierarchyType.None, false, (int)AqarPress.Data.EntityType.RoleEntity, typeof(RoleEntity), typeof(RoleEntityFactory), false);
				AddNavigatorMetaData<RoleEntity, EntityCollection<UserEntity>>("Users", a => a._users, (a, b) => a._users = b, a => a.Users, () => new RoleRelations().UserEntityUsingRoleId, typeof(UserEntity), (int)AqarPress.Data.EntityType.UserEntity);
			}
		}
