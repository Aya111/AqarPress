...
namespace DB_A4D6F8_AqarPress.Data.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class UserEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("UserEntity", InheritanceHierarchyType.None, false, (int)DB_A4D6F8_AqarPress.Data.EntityType.UserEntity, typeof(UserEntity), typeof(UserEntityFactory), false);
				AddNavigatorMetaData<UserEntity, EntityCollection<ProjectDiscussionEntity>>("ProjectDiscussions", a => a._projectDiscussions, (a, b) => a._projectDiscussions = b, a => a.ProjectDiscussions, () => new UserRelations().ProjectDiscussionEntityUsingCommenterId, typeof(ProjectDiscussionEntity), (int)DB_A4D6F8_AqarPress.Data.EntityType.ProjectDiscussionEntity);
				AddNavigatorMetaData<UserEntity, RoleEntity>("Role", "Users", (a, b) => a._role = b, a => a._role, (a, b) => a.Role = b, DB_A4D6F8_AqarPress.Data.RelationClasses.StaticUserRelations.RoleEntityUsingRoleIdStatic, ()=>new UserRelations().RoleEntityUsingRoleId, null, new int[] { (int)UserFieldIndex.RoleId }, null, true, (int)DB_A4D6F8_AqarPress.Data.EntityType.RoleEntity);
			}
		}
		...
		{
			get { return (System.DateTime)GetValue((int)UserFieldIndex.LastLoginDate, true); }
